...
<a href="https://osf.io/download/9zqmt/" download="psy400_1.R">
...
Our next step involves categorizing the newly created shock_index variable based on the defined normal range (0.5 to 0.7 beats/mmHg 
 min). This can be done using the `case_when()` function from the `dplyr` package.
