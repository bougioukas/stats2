...
<a href="https://osf.io/download/ghw86/" download="psy400_6.R"> <button type="button" class="btn btn-primary"> <i class="bi bi-download"></i> Download R Script </button> </a>
:::

::: {.callout-tip appearance="simple"}
## Get the Data birtweight

You can download the Excel dataset **birtweight** from here:

<a href="https://osf.io/download/8j64u/" download="birtweight.xlsx"> <button type="button" class="btn btn-success"> <i class="bi bi-file-earmark-excel"></i> Download Excel Data </button> </a>
:::
...
### Hypothesis Testsing for $\beta_1$
...
To select the best fitting straight line for this dataset, it is necessary to estimate the values $b_o$ and $b_1$ of parameters $\beta_o$ and $\beta_1$ in @eq-line1. The regression equation of the model becomes:
...
$$ 95\% \ \text{CI}_{b_1} = b_1 \pm t_{548; 1-a/2} \cdot \text{SE}_{b_1}$$ {#eq-tci}
